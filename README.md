# Beauty Store theme
A BeautyStore boilerplate theme to create stores in the VTEX IO platform.
...
## History
This was developed by our internal team in the Hackatheme event (team name: Bonytos de Tema)

// SOON TEAM MEMBERS NAMES AND PICS :)
